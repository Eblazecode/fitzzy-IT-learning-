...
<div class="page-wraper">
    ...
    <div class="page-content bg-white">
        <!-- Page Heading Box ==== -->
        <div class="page-banner ovbl-dark" style="background-image:url(assets/christina-wocintechchat-com-vLwH8bWoi_8-unsplash.jpg);">
            <div class="container">
	...
	<!-- About Content ==== -->
            <div class="section-area section-sp2 bg-fix ovbl-dark join-bx text-center" style="background-image:url(assets/christina-wocintechchat-com-RTJIXQNne68-unsplash.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="join-content-bx text-white">
                                <h2>Become proficient in IT <br/> the best way</h2>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                    industry. Lorem Ipsum has been the industry's standard dummy
