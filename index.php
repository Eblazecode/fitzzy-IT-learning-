...
<head>
	...
	<!-- DESCRIPTION -->
    <meta name="description" content="Fittzy Technology.
 Fitzzy Tech Nigeria designs, develops, & delivers training on
                                    hundreds of IT topics from software Engineering to
                                    Data science, & Service Management Business  and project management
                                    in an undiute forms to hep every learner scale in a digital world
                                    with excellence" />

    <!-- OG -->
    <meta property="og:title" content="Fitzy Technoloy" />
    <meta property="og:description" content="Fitzzy Technology, ICT company" />
	<meta property="og:description" content="FITZZY " />
	<meta property="og:image" content="" />
	<meta name="format-detection" content="telephone=no">
	
	<!-- FAVICONS ICON ============================================= -->
	<link rel="icon" href="assets/fitzyy%20logo.png" type="image/x-icon" />
	<link rel="shortcut icon" type="image/x-icon" href="assets/fitzyy%20logo.png" />
	
	<!-- PAGE TITLE HERE ============================================= -->
	<title>FITZZY TECH </title>
    ...
    <div class="page-content bg-white">
                        ...
                        <div class="why-chooses-bx ">
                            <div class="ttr-accordion m-b30 faq-bx" id="accordion1">
                                <div class="join-content-bx text-white">
                                    <h2 class="title-head m-b0">Excellent ICT Training <span>uncensored</span></h2>
                                    Fitzzy Tech Nigeria designs, develops, & delivers training on
                                    hundreds of IT topics from software Engineering to
                                    Data science, & Service Management Business  and project management
                                    in an undiute forms to hep every learner scale in a digital world
                                ...
                                <a href="#" class="btn button-md mt-4">GET STARTED</a>
		...
		<div class="content-block">
			...
			<div class="section-area section-sp1 ovpr-dark bg-fix online-cours"
                 style="background-image:url(assets/CODING.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center text-white mb-5">
                            ...
                            <div class="join-content-bx text-white">Lorem ipsum dolor sit amet consectetur adipiscing elit litora
                                ...
                                porttitor nulla risus cras,
                                 libero posuere laoreet bibendum tortor.
                            </div>
						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-blackboard"></i><span class="counter">10 </span></h3>
									</div>
									<span class="cours-search-text">conducive classes</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-alarm-clock"></i><span class="counter">6 </span>hours </h3>
									</div>
									<span class="cours-search-text">Flexible lecture time</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="cours-search-bx m-b30">
									...
									<span class="cours-search-text">seasoned instructors</span>
								</div>
							</div>


                            <a href="#" class="btn button-md offset-5">GET STARTED</a>
						</div>
					</div>
				</div>
			</div>
                    ...
                    <div class="row">
                        <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0" >
                            <div class="item"style="height: 300px">
                                <div class="cours-bx">
                                    <div class="action-box" style="height: 220px">
                                        <img src="assets/images/network2.jpg" alt="">
                                        <a href="#" class="btn">Read More</a>
                                    </div>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box" style="height: 200px">
                                        <img src="assets/images/web%20design.jpg" alt="">
                                        <a href="#" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Front-end web development</a></h5>
                                        <span>Programming</span>
                                    </div>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box" style="height: 220px">
                                        <img src="assets/images/dataanalysis.png" alt="">
                                        <a href="#" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box" style="height: 200px">
                                        <img src="assets/images/web%20dev1.jpg" alt="">
                                        <a href="#" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Back-end web development</a></h5>
                                        <span>Programming</span>
                                    </div>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Full-stack web development</a></h5>
                                        <span>Programming</span>
                                    </div>
                        ...
                        <a href="courses.php" class="btn button-md offset-lg-5 pt-3">see more</a>
                    </div>
                </div>
            </div>
            <!-- Popular Courses END -->
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <div class="courses-post">
                                <div class="ttr-post-media media-effect">
                                    <a href="#"><img src="assets/christina-wocintechchat-com-RTJIXQNne68-unsplash.jpg" alt=""></a>
                                </div>
                                <div class="ttr-post-info">
                                    <div class="ttr-post-title ">
                                        <h2 class="post-title">Profficiency through Hand-ons</h2>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12 m-b30">
                            <div class="bg-primary text-white contact-info-bx m-b30">
                                <h2 class="m-b10 title-head">Certifications <span>Availiable</span></h2>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center heading-bx">
							<h2 class="title-head m-b0">Training <span>Methods</span></h2>
							<p class="m-b0">We offer several training methods </p>
						</div>
					</div>
					<div class="row">
					<div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="assets/christina-wocintechchat-com-vLwH8bWoi_8-unsplash.jpg" alt="">
								</div>
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
											<div class="event-date"><i class="ti-briefcase"></i></div>
											<div class="event-month">coporate</div>
										</div>
									</div>
						...
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="assets/christina-wocintechchat-com-RTJIXQNne68-unsplash.jpg" alt="">
								</div>
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
											<div class="event-date"><i class="ti-video-camera"></i></div>
											<div class="event-month">virtual</div>
										</div>
									</div>
									<div class="event-info">
						...
						<div class="item">
							<div class="event-bx">
								...
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
											<div class="event-date"><i class="ti-blackboard"></i></div>
											<div class="event-month">students</div>
										</div>
									</div>
									<div class="event-info">
			...
			<!-- Testimonials -->
			<div class="section-area section-sp2 bg-fix ovbl-dark mb-5"
                 style="background-image:url(assets/CODING.jpg);">
                <div class="container">
					<div class="row">
			...
			<!-- Recent News
			      ...
			      <div class="col-lg-5 offset-lg-3 pt-5 pb-5 col-md-7">
                <form class="contact-bx ajax-form" action="http://educhamp.themetrades.
                com/demo/assets/script/contact.php">
                    <div class="ajax-message"></div>
                    <div class="heading-bx left">
                        <h2 class="title-head">Subscribe  <span>To our newsletter </span></h2>
                        <p>It is a long established fact that a reader will be
                            distracted by the readable content of a page</p>
                    </div>
                    <div class="row placeani">
                        ...
                        <div class="col-lg-12">
                            <button name="submit" type="submit" value="Submit" class="btn button-md"> Subscribe </button>
                        </div>
                    </div>
                </form>
            </div>
